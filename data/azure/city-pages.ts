...
export const azureCityPages: LandingPageConfig[] = cities.map((c) =>
  azurePage({
    ...
    heroVariant: `${c.local} We provide ${c.city} Azure AI proxy job support and proxy interview support on real Foundry, Azure OpenAI, Foundry agent, Azure AI Search RAG, and Azure ML work — day-to-day delivery, production incidents, and interview preparation across ${c.industries}.`,
    ...
    bottomCTABody: `In-house Microsoft Foundry, Azure OpenAI, and Azure ML experts available in ${c.city} hours — proxy job support for live projects and production issues, or proxy interview support (technical preparation; you attend your own interview). Talk to ProxyTechSupport on WhatsApp now.`,
