...
export const modernDotnetAzureAiJobSupport: LandingPageConfig = {
  ...
  relatedLinks: {
    ...
    additionalLinks: [
      ...
      { label: 'Microsoft Foundry Proxy Job Support', href: '/microsoft-foundry-proxy-job-support/' },
      { label: '.NET Microsoft Foundry Job Support', href: '/dotnet-microsoft-foundry-job-support/' },
    ],
  },
