...
export const jobSupportLinks = [
  ...
  { label: 'Amazon Interview & Career Support Hub', href: '/amazon-interview-career-support/' },
  { label: 'Amazon Proxy Interview Support', href: '/amazon-proxy-interview-support/', hidden: true },
  { label: 'Amazon Proxy Job Support', href: '/amazon-proxy-job-support/', hidden: true },
  ...
  { label: 'Hugging Face Proxy Job Support Hub', href: '/hugging-face-proxy-job-support/' },
  { label: 'Hugging Face Proxy Interview Support', href: '/hugging-face-proxy-interview-support/' },
  { label: 'Hugging Face Engineer Job Support', href: '/hugging-face-engineer-job-support/', hidden: true },
  { label: 'Hugging Face Production Support', href: '/hugging-face-production-support/', hidden: true },
  { label: 'Transformers Job Support', href: '/huggingface-transformers-training-job-support/', hidden: true },
  { label: 'PEFT / LoRA Fine-Tuning Job Support', href: '/peft-fine-tuning-job-support/', hidden: true },
  { label: 'TRL Post-Training Job Support', href: '/trl-job-support/', hidden: true },
  { label: 'HF Inference Endpoints Job Support', href: '/huggingface-inference-endpoints-job-support/', hidden: true },
  { label: 'HF LLM Serving (vLLM / TGI) Job Support', href: '/huggingface-llm-serving-job-support/', hidden: true },
  { label: 'smolagents Job Support', href: '/smolagents-job-support/', hidden: true },
  { label: 'Sentence Transformers & RAG Job Support', href: '/huggingface-semantic-search-job-support/', hidden: true },
