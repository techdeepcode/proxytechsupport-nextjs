...
export const jobSupportLinks = [
  ...
  { label: 'AWS AI/ML & Generative AI Hub', href: '/aws-ai-ml-job-support/' },
  { label: 'Amazon Bedrock Job Support', href: '/amazon-bedrock-job-support/', hidden: true },
  { label: 'Amazon Bedrock AgentCore Support', href: '/amazon-bedrock-agentcore-job-support/', hidden: true },
  { label: 'Amazon SageMaker Job Support', href: '/amazon-sagemaker-job-support/', hidden: true },
  { label: 'Amazon SageMaker AI Job Support', href: '/amazon-sagemaker-ai-job-support/', hidden: true },
  { label: 'AWS MLOps Job Support', href: '/aws-mlops-job-support/', hidden: true },
  { label: 'Azure AI Proxy Job & Interview Support Hub', href: '/azure-ai-ml-proxy-job-support/' },
  { label: 'Microsoft Foundry Proxy Job Support', href: '/microsoft-foundry-proxy-job-support/', hidden: true },
  { label: 'Foundry Agent Service Proxy Job Support', href: '/microsoft-foundry-agent-service-proxy-job-support/', hidden: true },
  { label: 'Azure AI Search Proxy Job Support', href: '/azure-ai-search-proxy-job-support/', hidden: true },
  { label: 'Azure RAG Proxy Job Support', href: '/azure-rag-proxy-job-support/', hidden: true },
  { label: 'Azure Machine Learning Proxy Job Support', href: '/azure-machine-learning-proxy-job-support/', hidden: true },
  { label: 'Azure MLOps Proxy Job Support', href: '/azure-mlops-proxy-job-support/', hidden: true },
  { label: 'Azure AI Proxy Interview Support', href: '/azure-ai-ml-proxy-interview-support/', hidden: true },
