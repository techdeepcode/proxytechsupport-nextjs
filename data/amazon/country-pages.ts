...
function proxyInterview(c: Country): LandingPageConfig {
  return amazonServicePage({
    ...
    painIntro: `Facing an Amazon interview in ${c.name}? Amazon proxy interview support (also searched as interview proxy support) gives ${c.demonym} candidates real-time expert support for the technical and behavioral rounds — aligned to your local hours.`,
    heroVariant: `We support ${c.demonym} Amazon candidates across the rounds Amazon uses — Online Assessment, technical phone screen, coding and system design, SQL/data and ML where relevant, and the behavioral Leadership Principles loop and Bar Raiser. ${c.context} Proxy interview support means real-time expert technical help on the exact rounds your interview covers — you attend and complete your own interview. Independent of Amazon; no guarantee of selection.`,
    ...
    bottomCTABody: `In-house experts provide real-time Amazon interview support and Leadership Principles support for ${c.demonym} candidates. You attend your own interview; we back you to perform. Independent of Amazon; no guarantee of selection. Talk to ProxyTechSupport on WhatsApp now.`,
    relatedLinks: relatedLinks({
