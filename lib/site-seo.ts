...
export const HOME_META_DESCRIPTION =
  'Get real-time IT job support, proxy interview support, technical interview assistance, production issue help, and profile engineering for developers across USA, UK, Canada, Australia, Europe, Germany, Singapore, and New Zealand. Expert proxy support for AI, ML, Agentic AI, MLOps, LLMOps, RAG, DevOps, SRE, Cloud, AWS, Azure, Data Science, Cybersecurity, Java, Python, React, Next.js, .NET, Node.js, Angular, Full-Stack, Salesforce, Dynamics 365, Zoho CRM, HubSpot, SAP CRM, Testing, Digital Analytics, and enterprise technologies. Same-day support available.';
...
export const HOME_OG_DESCRIPTION =
  'Urgent IT job support, proxy interview support, production issue assistance, and profile engineering for developers across USA, UK, Canada, Australia, Europe, Germany, Singapore, and New Zealand. Expert support for AI, ML, Agentic AI, MLOps, LLMOps, RAG, DevOps, SRE, Cloud, AWS, Azure, Data Science, Cybersecurity, Java, Python, React, Next.js, .NET, Node.js, Angular, Full-Stack, Salesforce, Dynamics 365, Zoho CRM, HubSpot, SAP CRM, Testing, Digital Analytics, and enterprise technologies.';
